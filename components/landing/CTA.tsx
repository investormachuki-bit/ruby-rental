    ...
    <section className="bg-gradient-to-br from-black via-gray-950 to-black py-28">
      <div className="mx-auto max-w-5xl px-6 text-center">
        ...
        <p className="mx-auto mt-8 max-w-3xl text-xl leading-9 text-gray-300">
          Spend less time chasing rent, searching for records and reconciling
          payments. Spend more time making informed decisions and growing your
          investment.
        </p>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-5">
          ...
          <a
            ...
            className="rounded-2xl bg-[#D4AF37] px-10 py-5 text-lg font-bold text-black transition hover:scale-105 hover:shadow-2xl"
          >
            Book a Demo
          </a>

          <a
            href="https://wa.me/254796594295"
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-2xl border border-white/20 px-10 py-5 text-lg font-semibold text-white transition hover:border-[#D4AF37] hover:text-[#D4AF37]"
          >
            Chat on WhatsApp
          </a>
