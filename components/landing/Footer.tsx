        ...
        <div className="grid gap-12 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-6 leading-8 text-gray-400">
              ...
              finances and business performance
          ...
          <div>
            ...
            <button className="mt-8 rounded-xl bg-[#D4AF37] px-6 py-3 font-semibold text-black transition hover:scale-105">
        ...
        <div className="mt-16 border-t border-white/10 pt-8">
          ...
          <div className="flex flex-col items-center justify-between gap-4 text-center text-sm text-gray-500 md:flex-row">
            ...
            <p>
              ...
              © {new Date().getFullYear()} Ruby Rental.
