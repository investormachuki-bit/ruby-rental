      ...
      <div className="mx-auto grid min-h-[88vh] max-w-7xl items-center gap-16 px-6 py-24 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-12 flex flex-wrap gap-5">
            ...
            <button className="rounded-2xl bg-[#D4AF37] px-8 py-4 text-lg font-bold text-black transition hover:scale-105 hover:shadow-2xl">
            ...
            <button
              disabled
              className="cursor-not-allowed rounded-2xl border border-white/20 px-8 py-4 text-lg font-semibold text-gray-400"
            >
